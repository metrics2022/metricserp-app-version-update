                ...
                }
                {
                    isSectionShow ? (
                        ...
                        <View style={{ marginTop: 150, alignItems: "center" }}>
                            <Text style={{ color: "#000", fontSize: 20, fontWeight: "700", textAlign: "center",marginBottom: 10 }}>
                                Sales Order Created
                                {"\n"} {/* Adds a line break */}
                                <Text style={{ color: "#1788F0" }}>
                                    #{salesOrderSubmitState.salesOrderData.data}
                                </Text>
                            </Text>
                            <Text> {/* Wraps the button in a separate text container */}
                                <TouchableOpacity
                                ...
                                >
                                    <Text style={{ color: "#FFF", fontSize: 18, fontWeight: "600", textTransform: "uppercase" }}>
                                        Home
                                    </Text>
                                </TouchableOpacity>
                            </Text>
