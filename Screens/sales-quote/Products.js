...
const Products = ({ route, navigation }) => {
    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
                ...
                >
                    ...
                    <TouchableWithoutFeedback onPress={() => { setIsEditing(false); setEditingPriceProductId(null); Keyboard.dismiss(); }} accessible={false}>
                        ...
                        <View style={styles.modalView}>
                            <TouchableOpacity onPress={() => handleClose()} style={{ position: "absolute", right: -10, top: -10, zIndex: 99, backgroundColor: "#FFF", borderRadius: 40, overflow: "hidden" }}>
                            ...
                            globalReducerState?.getGlobalData?.data?.allow_sq_price_change == 1 ? (
                                ...
                                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                                    <Text style={{ color: "#3d5a80", fontSize: 18, textAlign: "center", position: "relative" }}>
                                    ...
                                    <TextInput
                                        ...
                                        style={{ color: "#3d5a80", fontSize: 18, textAlign: "center" }}
                                    />
                                ...
                                <Text
                                    onPress={() => handleIconPress(productId)}
                                    style={{ color: "#3d5a80", fontSize: 18, textAlign: "center", position: "relative" }}
                                >
                                    {globalReducerState?.getGlobalData?.data?.currency?.currency_code}{" "}
                                    {marketPrice !== "" && (
                            ...
                            <TouchableOpacity
                                disabled={product_qty > 0 ? false : true}
                            ...
                            </TouchableOpacity>
                            {
                                ...
                                <TextInput
                                    keyboardType='numeric'
                                    autoFocus
                                    value={Number(product_qty).toString()}
                                    onChangeText={(e) => handleNumberChange(e)}
                                    style={{ paddingHorizontal: 20, fontSize: 20, color: "#000" }}
                                />
                                ) : (
                                <Text onPress={() => setIsEditing(true)} style={{ paddingHorizontal: 20, fontSize: 20, color: "#000" }}>
                                    {Number(product_qty)}
                                </Text>
                                )
                            }
                            ...
                            <Text style={{ color: "#3d5a80", fontSize: 16, textAlign: "center", marginTop: 15 }}>
                            <Text style={{ fontWeight: "700", color: "#3d5a80" }}>Total:</Text>{" "}
                            ...
                            <Pressable
                                ...
                                dispatch(addToCartFromQuote({
                                    ...
                                    price,
                                    itemLineDesc,
                                    cartItemId: Date.now() + Math.random(), // Add unique cartItemId
                                    }
                                }));
                                handleClose();
                                setIsEditing(false);
            ...
            <View style={[styles.centedView, { backgroundColor: modalVisible2 ? "rgba(0,0,0,0.5)" : "transparent", display: modalVisible2 ? "flex" : "none" }]}>
                <Modal
                    animationType="fade"
                    transparent={true}
            ...
            <View style={[styles.centedView, { backgroundColor: categoryModal || brandModal ? "rgba(0,0,0,0.5)" : "transparent", display: categoryModal || brandModal ? "flex" : "none" }]}>
